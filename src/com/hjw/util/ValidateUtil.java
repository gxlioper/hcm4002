...
public class ValidateUtil {
	...
	public static void main(String[] args) {
		// 正确
		System.out.println(ValidateUtil.IDCardValidatechenk("13243319780115562x"));
	}
	/**
	 * ------------------------15位和18位身份证验证start-----------------------------
	 */
     ...
     */
    @SuppressWarnings("unchecked")
    public static String IDCardValidatechenk(String IDStr) {
    	IDStr = IDStr.toUpperCase();
        String errorInfo = "";// 记录错误信息
        String[] ValCodeArr = { "1", "0", "X", "9", "8", "7", "6", "5", "4",
                "3", "2" };
		...
		if (IDStr.length() == 18) {
			if (Ai.equals(IDStr) == false) {
				...
				return errorInfo;
//				throw new BaseBllException(errorInfo, null,JsonAlertType.ALERT);
			}
		}
        return "";
    }
