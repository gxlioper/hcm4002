...
public class GroupInfoDTO implements java.io.Serializable {
    ...
    private long yjCount;//已检查总人数
    
    private long exam_count;
    private long yexam_count;
    
    private String status;//分组状态 Y  正常 D 冻结  被冻结的分组不能新增人
	...
	public void setYexam_count(long yexam_count) {
		this.yexam_count = yexam_count;
	}
