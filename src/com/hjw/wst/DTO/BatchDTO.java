...
public class BatchDTO implements java.io.Serializable {
	 private static final long serialVersionUID = -97502163798576023L;
	    ...
	    private long bexam_number;//补做人数
	    private int accountflag;//锁定
	    ...
	    private String is_showamounts;//导检单是否显示金额 0 不显示，1显示
	    private String is_showseals;//导检单是否显示印章0 不显示，1显示	
	    private double tamt;
	    private double gamt;
		...
		public long getBexam_number() {
			return bexam_number;
		}

		public void setBexam_number(long bexam_number) {
			this.bexam_number = bexam_number;
		}
		...
		public void setAccountflag(int accountflag) {
			...
			if(accountflag==1){
				this.setAccountflags("已锁定");
			}else if(accountflag==0){
				this.setAccountflags("未锁定");
			}
		}

		public String getAccountflags() {
			return accountflags;
		}

		public void setAccountflags(String accountflags) {
		...
		public void setAccountuname(String accountuname) {
			this.accountuname = accountuname;
		}
		...
		public String getIs_showamounts() {
			return is_showamounts;
		}

		public void setIs_showamounts(String is_showamounts) {
			this.is_showamounts = is_showamounts;
		}

		public String getIs_showseals() {
			return is_showseals;
		}

		public void setIs_showseals(String is_showseals) {
			this.is_showseals = is_showseals;			
		}
		...
		public void setIs_showamount(int is_showamount) {
			...
			if(is_showamount==0){
				this.setIs_showamounts("否");
			}else if(is_showamount==1){
				this.setIs_showamounts("是");
			}else {
				this.setIs_showamounts("未知");
			}
		}
		...
		public void setIs_showseal(int is_showseal) {
			...
			if(is_showseal==0){
				this.setIs_showseals("否");
			}else if(is_showseal==1){
				this.setIs_showseals("是");
			}else {
				this.setIs_showseals("未知");
			}
		}
		...
		public void setOverflag(String overflag) {
			...
			if("1".equals(overflag)){
				this.setOverflags("已结帐");
			}else if("0".equals(overflag)){
				this.setOverflags("未结帐");
			}
		}
