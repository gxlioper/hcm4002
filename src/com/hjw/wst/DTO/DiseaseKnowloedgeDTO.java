...
public class DiseaseKnowloedgeDTO implements java.io.Serializable {
	 ...
	 private String disease_logic_id;
	 private String sex;
	 private long minAge;
	 private long maxAge;
	 private long sug_id;
	...
	public void setDisease_report(long disease_report) {
		...
		if(disease_report == 0){
			this.disease_reports = "上报";
		}else{
			this.disease_reports = "不上报";
		}
	}
	...
	public void setDisease_team_show(long disease_team_show) {
		...
		if(disease_team_show == 0){
			this.disease_team_shows = "显示";
		}else{
			this.disease_team_shows = "不显示";
		}
	}
	...
	public long getDis_dep_id() {
		return dis_dep_id;
	}

	public void setDis_dep_id(long dis_dep_id) {
		this.dis_dep_id = dis_dep_id;
	}
	...
	public DiseaseKnowloedgeDTO() {
		// TODO Auto-generated constructor stub
	}
	public String getDisease_logic_id() {
		return disease_logic_id;
	}

	public void setDisease_logic_id(String disease_logic_id) {
	...
	public void setDefault_value(String default_value) {
		if(default_value.equals("Y")){
			this.default_value = "是";
		}else{
			this.default_value = "否";
		}
	}
	public long getId() {
		return id;
	...
	public void setDisease_type(String disease_type) {
		...
		if(disease_type.equals("Y")){
			this.disease_type_d ="阳性发现";
		}else{
			this.disease_type_d = "疾病";
		}
	}
	...
	public String getDisease_classification() {
		return disease_classification;
	}
	public void setDisease_classification(String disease_classification) {
