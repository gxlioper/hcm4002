...
public class ExamInfoUserDTO implements java.io.Serializable {
	 private static final long serialVersionUID = -97502163798576023L;
	    ...
	    private String zytjlx;
	    private String zywhys;
	    private String zytjlxname;
	    private String zywhysname;	
	    private String zyb_final_status;//职业病 总检状态 Z  N
	    private String zyb_final_time;  //职业病  总检时间
	    private String zyb_final_doctor;//职业病总检医生名字 
	    
	    private String data_code_children;   //体检类型
	    
	    private int comon_report_type;
	    
	    private String comonReportType;
        ...
        private int readFlag1;
        private String readFlags;
        private String readFlags1;
        private BodyJQ body;
    ...
    public void setJoin_num(long join_num) {
    ...
    public String getChargeType() {
		...
		public String getComonReportType() {
			return comonReportType;
		}

		public void setComonReportType(String comonReportType) {
			this.comonReportType = comonReportType;
		}
		...
		public String getZytjlxname() {
			return zytjlxname;
		}

		public void setZytjlxname(String zytjlxname) {
			this.zytjlxname = zytjlxname;
		}

		public String getZywhysname() {
			return zywhysname;
		}

		public void setZywhysname(String zywhysname) {
			this.zywhysname = zywhysname;
		}
		...
		public void setApptype(String apptype) {
			...
			if(StringUtil.isEmpty(this.apptype)){
				this.setApptypename("普通");
			}else if("2".equals(this.apptype)){
				this.setApptypename("职业病");
			} else{
				this.setApptypename("普通");
			}
		}
		...
		public void setIs_report_print(String is_report_print) {
			...
			if("Y".equals(is_report_print)){
				this.setIs_report_print_y("已打印");
			}else{
				this.setIs_report_print_y("未打印");
			}
		}
		...
		public void setStrp1(String strp1) {
			this.strp1 = strp1;
		}
		...
		public String getZyb_final_time() {
		...
		public void setZyb_final_time(String zyb_final_time) {
		...
		public BodyJQ getBody() {
			return body;
		}

		public void setBody(BodyJQ body) {
			this.body = body;
		}
		...
		public int getReadFlag1() {
			return readFlag1;
		}

		public String getReadFlags1() {
			return readFlags1;
		}
		...
		public void setReadFlag1(int readFlag1) {
			this.readFlag1 = readFlag1;
		}

		public void setReadFlags1(String readFlags1) {
			this.readFlags1 = readFlags1;
		}
