...
public class DataAnalysisModel {
	...
	private List<DataAnalysisConditionDTO> condition;
	private String conditions1;
	private List<DataAnalysisConditionDTO> condition1;
	...
	public List<DataAnalysisConditionDTO> getCondition() {
		return condition;
	}
	public void setCondition(List<DataAnalysisConditionDTO> condition) {
		this.condition = condition;
	}
	public List<DataAnalysisConditionDTO> getCondition1() {
		return condition1;
	}
	public void setCondition1(List<DataAnalysisConditionDTO> condition1) {
