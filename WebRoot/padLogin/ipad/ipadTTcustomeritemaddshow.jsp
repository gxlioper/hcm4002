...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/padLogin/ipad/ipadTTcustomeritemaddshow.js?randomId=<%=Math.random()%>"></script>
<style>
#main {
	width: auto;
	height: auto;
...
<input type="hidden" id="isShowHhPay"
	value="<s:property value="model.is_show_hh_pay"/>">
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		...
		<div id="ttzkl1" style="width: 10%; float: left;">
			折扣率&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="ttzkhze1" style="width: 13%; float: left;">

			折扣后总额&nbsp;&nbsp;&nbsp;&nbsp;
			<s:if test='teamAmountViewFlag==1'>
				<input type="text" id="amount" value="0"
					style="height: 26px; width: 50%;" />
				<span id="ttyuan1">(元)</span>
			</s:if>
			<s:else>	**<input type="hidden" id="amount" value="0"
					style="height: 26px; width: 50%;" />(元)
</s:else>
		</div>
		<div style="width: 15%; float: left;">
			单位结算总额&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="team_pay"
		...
		<div style="width: 31%; float: left;">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<div>
				<span id="z_zhi" style="width: 60%;"></span>
			</div>
		</div>
	</div>
</fieldset>
