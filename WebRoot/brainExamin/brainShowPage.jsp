...
<script type="text/javascript" src="<%=request.getContextPath()%>/brainExamin/brainShowPage.js?randomId=<%=Math.random()%>"></script>
 	...
 	<fieldset style="margin:5px ;padding-right:0; height: 720px; border: 0px;">
		<div class="easyui-layout" fit="true" style="margin: 1px 0px 1px -10px;">
		    <div id="center"  data-options="region:'center',title:''">
				 ...
				 <div id="gongzhong">
				 	<fieldset style="margin-left: 15px;margin-right: 15px; padding-right: 0;"  id="yc_zy" >
						<legend>
							<strong>职业病史</strong>
						</legend>
						<div class="user-query">
				 ...
				 <div id="bs_zhengZhuang" class='easyui-panel' style=" width:97%; margin-left: 15px; border:0px; display: none;">
					<dl>
						<dd style="margin-top:5px;">症状名称检索：<input type="text" id="quest_zhengZhaung" style="width:200px;height:30px;"/></dd>
						<!-- <dd><a href="javascript:addZhengZhuang();"  class="easyui-linkbutton c6" style="width:50px;height:30px; margin-top:5px; margin-left: 5px;">添加</a></dd> -->
					</dl>
					<div id="zhengZhaungTitle">
