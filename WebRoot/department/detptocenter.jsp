...
<div class="dialog-button-box">
	<div class="inner-button-box">
	    ...
	    <a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;" onclick="javascript:$('#dep_center').dialog('close')">取消</a>
	</div>
</div>
