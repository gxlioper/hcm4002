...
<script type="text/javascript" src="<%=request.getContextPath()%>/CiseaseLogic/disease_logic.js?randomId=<%=Math.random()%>"></script>
<style>
li:hover{
    background:#c9daf8;
    display:block;
...
<legend><strong>报告样本查询</strong></legend>
			<div class="user-query">
				<dl>
					<dt style="width:8.5%;">阳性指标/疾病名称</dt>
					<dd><input class="textinput"  type="text" id="c_logic_name"   style="height:26px;width:140px;"/></dd>
					<dt style="width:8.5%;text-align: center;">阳性指标/疾病编码</dt>
					<dd><input class="textinput"  type="text" id="c_logic_num"   style="height:26px;width:140px;"/></dd>
					<dt style="text-align: right;padding-right: 10px">疾病类型:</dt>
					<dd>
						<select id="c_logic_type" class="easyui-combobox"  style="width:100px;"  data-options='panelHeight:80'>   
...
<legend><strong>疾病逻辑列表</strong></legend> 
 ...
 <div id="dlg-custedit" class="easyui-dialog"  data-options="width:'70%',closed: true,cache: false,modal:true,top:50"  style="min-height:300px"></div>
