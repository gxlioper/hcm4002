...
<script type="text/javascript" src="<%=request.getContextPath()%>/crm/crmvisitplan/crmallvisitplanlist.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>健康计划查询</strong></legend>
			<div class="user-query" >
				<dl>
					...
					<dd>
						<input  type="text" class="textinput" id="name"    style="height:16px;width:140px;" />
					</dd>
			...
			<dd>
				<input  class="easyui-combobox"  id="visit_status"
					...
					<dd><a href="javascript:getCrmVisitPlanList();" class="easyui-linkbutton c6" style="width:100px;">查询</a></dd>
