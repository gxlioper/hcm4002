...
<p class="print">&nbsp;</p>
<p align="center"  class="print" class="STYLE4"><s:property value="model.comname"/>-<s:property value="model.batch_name"/>明细</p>
<p>&nbsp;</p>
...
<table width="950" height="389" border="1" align="center" cellspacing="0">
  ...
  <tr>
    <td><div width="85" align="right" class="STYLE4">合同编号：</div></td>
    <td colspan="3">&nbsp;<s:property value="model.contract_num"/></td>    
    <td><div align="right" class="STYLE4">甲方单位：</div></td>
    <td  colspan="3">&nbsp;<s:property value="model.comname"/></td>
  </tr>
  <tr>
    <td width="85"><div align="right" class="STYLE4">甲方联系人</div></td>
  ...
  <tr>
    ...
    <td>&nbsp;<s:property value="model.exam_fee"/>(元)</td>
  ...
  <tr>
    ...
    <td><div align="right">&nbsp;<s:property value="amount" />(元/人)</div></td>
...
<p class="nprint" align="center">
  <input type="button" name="Submit2" value="打印合同" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
