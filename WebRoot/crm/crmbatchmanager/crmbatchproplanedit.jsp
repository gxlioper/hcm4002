...
<script type="text/javascript" src="<%=request.getContextPath()%>/crm/crmbatchmanager/crmbatchproplanedit.js?randomId=<%=Math.random()%>"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			<dt>计划开始日期</dt>
			<dd><input class="easyui-datebox"   type=text id="startdate" style="width:100px;height:26px;" value='<s:property value="exam_date"/>'></input></dd>
			<dt>计划结束日期</dt>
			<dd><input class="easyui-datebox"   type=text id="enddate" style="width:100px;height:26px;" value='<s:property value="exam_date_end"/>'></input></dd>
			<dt>日体检人数</dt>
