var toolbar = [{
    ...
    handler:function(){
    	$("#dlg-edit").dialog({
    		title:'新增体检综述',
    		href:'getEditExamSummaryGuidanceLib.action'
    	});
...
function getGrid(){
	var model = {"guidance_word":$('#ser_word').val()};
	   $("#SummaryGuidanceList").datagrid({
     ...
     columns:[[{align:"center",field:"guidance_word","title":"体检综述名称","width":15},
     		  {align:'center',field:"guidance_pinyin","title":"助记码","width":10},
     		  {align:"center",field:"guidance_content","title":"体检综述内容","width":35},
...
function f_xgViewWords(id){
		$("#dlg-edit").dialog({
			title:'修改体检综述',
			href:'getEditExamSummaryGuidanceLib.action?id='+id
		});
		$("#dlg-edit").dialog('open');
}
...
function f_delViewWords(id){
	$.messager.confirm("提示信息","是否删除体检综述？",function(r){
		if(r){
			var str = '<div class="loading_div" style=" position:fixed; background-image:url(../../images/bg_tm.png); left:0;top:0; overflow:hidden; width:100%; height:100%; display: block; z-index: 89999; ">' + '<div style="width:70px;  height:75px; margin-top:-38px; position:absolute; top:50%; left:50%; margin-left:-35px;"><img src="../../images/loading.gif" width="70" height="75" /></div></div>';
			$("body").prepend(str);
			$.ajax({
				url : 'delExamSummaryGuidanceLib.action?id='+id,
				type : 'post',
