...
function f_cancel_mail(){
	...
	$.ajax({
		...
		success:function(data){
			$(".loading_div").remove();
			$.messager.alert('提示信息', '取消邮寄成功!',function(){});
	    	$("#dlg-s").dialog("close");
	    	if($("#ser_exam_num").val() != ''){
...
function f_up_remarkey(){
 ...
 <fieldset style="margin:5px;padding-right:0;">
	<legend><strong>报告邮寄明细</strong></legend>
		<div class="user-query">
			...
			<dl>
				<dt>邮编:</dt>
				<dd><input type="text" id="receive_postcode" readonly="readonly" value="<s:property value="receive_postcode"/>" class="textinput boder_ck"/></dd>
				<dt>邮寄日期：</dt>
				<dd><input type="text" id="receive_date" readonly="readonly" value="<s:property value="join_date"/>" class="textinput boder_ck" /></dd>
			</dl>
			<dl>
				<dt>地址：</dt>
				<dd><input type="text" style="width:390px;" id="receive_address" readonly="readonly" value="<s:property value="receive_address"/>" class="textinput boder_ck"/></dd>
			</dl>
			<dl>
				<dt>备注：</dt>
...
<div id="search-buttons"  class="dialog-button-box">
	<div class="inner-button-box">
		<a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:80px;" onclick="javascript:f_up_remarkey()">修改备注</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;" onclick="javascript:f_cancel_mail()">取消邮寄</a>
