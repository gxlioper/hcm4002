...
function checkinput() {
	...
	var reporttypes = document.getElementsByName("report_type")[0].value;
	if($("#report_name").val()==''){
		...
		return false;
	}else if(($("#report_address").val()!='')&&(reporttypes=='')){
...
<input type="hidden" id="reportid" value="<s:property value="model.id"/>">
<fieldset style="margin: 5px; padding-right: 0;">
	<legend>
		<strong>修改报表模板</strong>
	</legend>
	<div class="user-query">
		<dl>
			...
			<dd><input class="easyui-textbox" type=text id="report_name" style="width:120px;height:26px;" value="<s:property value='model.report_name'/>"/></dd>		
		</dl>
		<dl>
			<dt>
				所属父级
		...
		<dl>
			...
			<dd><input class="easyui-textbox" id="report_address" name="report_address"					
					data-options="height:26,width:120,panelHeight:'auto'" value="<s:property value='model.report_address'/>"></dd>	
		</dl>
		<dl>
			<dt>
				上传模板
		...
		<dl>
			...
			<dd><input  class="easyui-textbox" type="text" id="seq_code" style="width:60px;height:26px;" value="<s:property value='model.seq_code'/>"/></dd>				
		</dl>
