...
//加入flv播放器
FCKConfig.Plugins.Add( 'flvPlayer','zn') ;
...
FCKConfig.ToolbarSets["Default"] = [
	['DocProps','-',/*'Save',*/'NewPage','Preview','-'],//去掉保存
...
FCKConfig.SmileyPath	= FCKConfig.BasePath + 'images/smiley/emoticons/' ;
