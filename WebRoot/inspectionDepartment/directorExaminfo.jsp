...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/directorExaminfo.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>信息检索</strong></legend>
 ...
 <div data-options="region:'west',split:true" style="width:59%;">
      <table id="groupusershow">
      </table>	
</div>
<div data-options="region:'center'">
	<div class="easyui-tabs" data-options="fit:true,border:false,plain:true">   
	    <div title="收费项目列表" style="padding:5px;">
