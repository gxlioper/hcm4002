...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/exam_summary_approve.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>未审核人员</strong></legend>
			<div class="user-query">
				<dl>
				    <dt style="height:26px;width:70px;"><s:text name="tjhname"/></dt>
					<dd><input class="easyui-textbox"  type="text" id="serch_exam_num" value="" style="height:26px;width:100px;ime-mode: disabled;"/></dd> 
					<dd><a href="javascript:getapproveinfo();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:90px;">查询审核</a></dd>
					<dd style="color:red;" id="error"></dd>
					<dd>
					<span style="margin-left:25px;">未审核的人数为：<font style="color: red;font-weight:bold;" id="wz_count">0</font>人，
					当天已审核人数为：<font style="color: blue;font-weight:bold;" id="yz_count">0</font>人，
					本人当天已审核人数为：<font style="color: blue;font-weight:bold;" id="zj_count">0</font>人。</span></dd>
				</dl>
			</div>
 </fieldset>
<div id="tt" class="easyui-tabs">
<div title="未审核人员列表" style="">
...
<legend><strong>信息检索</strong></legend>
			<div class="user-query">
				<dl>
				    <dt style="height:26px;width:100px;"><input id="ck_exam_num" type="checkbox"/><s:text name="dahname"/>或<s:text name="tjhname"/></dt>
				...
				<dl>
				  <%--  <dt style="height:26px;width:70px;"><input id="ck_arch_num" type="checkbox"/><s:text name="dahname"/></dt>					
                    ...
                    <dt style="height:26px;width:100px;"><input id="ck_custname" type="checkbox" />姓名</dt>
 ...
 <fieldset style="margin:5px;padding-right:0;">
<legend><strong>已审核人员列表</strong></legend>
