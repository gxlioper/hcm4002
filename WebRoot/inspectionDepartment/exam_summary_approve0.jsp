...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/exam_summary_approve0.js?randomId=<%=Math.random()%>"></script>
...
<div title="未审核人员列表" style="">
	...
	<legend><strong>信息检索</strong></legend>
			<div class="user-query">
				...
				<dl>
					<dt style="height:26px;width:110px;"><input id="ck_exam_doctor0" type="checkbox"/>总检医生</dt>					
					...
					<dt style="height:26px;width:80px;"><input id="ck_final_date0" type="checkbox" checked="checked"/>总检日期</dt>
