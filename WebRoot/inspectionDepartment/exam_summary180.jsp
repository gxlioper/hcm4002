...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/exam_summary180.js?randomId=<%=Math.random()%>"></script>
...
<div id="dlg-bohui" class="easyui-dialog"  data-options="width: 600,height: 400,closed: true,cache: false,modal: true"></div>
