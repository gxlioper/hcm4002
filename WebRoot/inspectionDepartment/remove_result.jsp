...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/remove_result.js?randomId=<%=Math.random()%>"></script>
		...
		<fieldset style="margin:5px;padding-right:0;">
    			<legend><strong>信息检索</strong></legend>
					<div class="user-query">
						<dl>
							<dd><s:text name="tjhname"/>：<input type="text" style="width:80px;ime-mode: disabled;" id="ser_num" name="ser_num" class="textinput"/></dd>
...
<div id="toolbar">
		...
		<a href="javascript:void(0)" id="save_exam" class="easyui-linkbutton c6" style="width:80px;" onclick="javascript:saveRemoveResult();">确定清除</a>
		</div>	
</div>
</body>
</html>