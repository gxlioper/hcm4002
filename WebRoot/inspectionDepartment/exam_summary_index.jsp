...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/exam_summary_index.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>信息检索</strong></legend>
			<div class="user-query">
				<dl>
					...
					<dd><input class="easyui-textbox"  type="text" id="exam_num1" value="" style="height:26px;width:100px;ime-mode: disabled;"/></dd> 
