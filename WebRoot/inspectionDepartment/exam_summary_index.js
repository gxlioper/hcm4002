	 ...
	 if($("#ck_tjlx")[0].checked){
		 ...
		 columns:[[
		    ...
		    {align:'center',field:'exam_types',title:'体检类型',width:80},	
		 	...
		 	{align:'center',field:'join_date',title:'体检时间',width:100,sortable:true},
		 	{align:'center',field:'statuss',title:'体检状态',width:60},
		 	{align:'center',field:'data_name',title:'体检类别',width:80},
		 	{align:'center',field:'item_num_s',title:'未检项目数量',width:80},
		 	{align:'center',field:'final_date',title:'总检时间',width:140,sortable:true},
