...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/view_exam_index.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>信息检索</strong></legend>
			<div class="user-query">
				...
				<dl>
				 ...
				 <dl>
				 <!-- <dd><input  name="exam_status" type="radio" onclick="getgroupuserGrid()" value="" checked="checked" /></dd>
		         <dt>全部人员</dt>
				 <dd><input  name="exam_status" onclick="getgroupuserGrid()" type="radio" value="N" /></dd>
				 <dt>未检人员</dt>
		         <dd><input  name="exam_status" type="radio" onclick="getgroupuserGrid()" value="M" /></dd>
		         <dt>全部已检</dt>
