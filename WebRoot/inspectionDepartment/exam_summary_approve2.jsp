...
<script type="text/javascript" src="<%=request.getContextPath()%>/inspectionDepartment/exam_summary_approve2.js?randomId=<%=Math.random()%>"></script>
...
<div title="获取审核人员列表" style="">
      <table id="getexamInfoList">
      </table>	
 </div>
<div title="已审核人员列表" style="">
			...
			<div class="user-query">
				...
				<dl>
				   <%-- <dt style="height:26px;width:70px;"><input id="ck_arch_num" type="checkbox"/><s:text name="dahname"/></dt>					
					...
					<dt style="height:26px;width:80px;"><input id="ck_final_date" type="checkbox" checked="checked"/>审核日期</dt>
					<dd><input class="easyui-datebox" id="final_time1" value="<s:property value="model.final_time1"/>" style="width:100px;height:26px;"/></dd>
                     ...
                     <dd><input class="easyui-datebox" id="final_time2" value="<s:property value="model.final_time2"/>" style="width:100px;height:26px;"/></dd>
				 	 <dt style="height:26px;width:80px;"><input id="ck_exam_doctor" type="checkbox" checked="checked"/>审核医生</dt>					
...
<div id="search" style="">
   <a href="javascript:huoqvzongjianone();" id="sh_getone" class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:150px;margin-left:5px;">获取单份审核人员</a>
   <a href="javascript:huoqvzongjianall();" id="sh_getall"  class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:150px;margin-left:25px;">获取上限审核人员</a>
   <a href="javascript:refrushwshlb();" id="sh_refrush"  class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:150px;margin-left:25px;">刷新未审核人员</a>  
   <span style="margin-left:25px;" id="js">检索：<input id="sss" class="easyui-searchbox" searcher="searcher" prompt="请输入<s:text name="tjhname"/>" style="width:150px;height:26px;ime-mode: disabled;"></input></span>
	<span style="margin-left:25px;">未审核：<font style="color: red;font-weight:bold;" id="wz_count">0</font>人，
	本人未审核：<font style="color: red;font-weight:bold;" id="t_count">0</font>人，
	当天已审核：<font style="color: blue;font-weight:bold;" id="yz_count">0</font>人，
	本人当天已审核：<font style="color: blue;font-weight:bold;" id="zj_count">0</font>人。</span>
</div> 
 </body>
 </html>