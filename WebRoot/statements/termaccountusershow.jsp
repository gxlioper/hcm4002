...
<script type="text/javascript" src="<%=request.getContextPath()%>/statements/termaccountusershow.js?randomId=<%=Math.random()%>"></script>
	...
	<fieldset style="margin: 5px; padding-right: 0;">
		...
		<div class="user-query">
			<dl>
				...
				<dd>
				    <select class="easyui-combobox" id="set_id" name="set_id"	data-options="height:26,width:230,panelHeight:'auto'"></select>
			    </dd>
			    <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="tjlx"/>体检类别</dt>
			      <dd><select class="easyui-combobox" id="tjlx" name="tjlx" data-options="height:26,width:140,panelHeight:'auto'"></select>
			      <a
						href="javascript:getteamExamInfoShowGrid();"
						class="easyui-linkbutton c6 l-btn l-btn-small"
						style="height: 26px; width: 60px;">查询</a>
					<a
						href="javascript:termcustadd();"
						class="easyui-linkbutton"
						style="height: 26px; width: 60px;">保存</a>						
			      </dd>	
               ...
               <dl>
			    ...
			    <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="join_date"/>体检日期</dt>
			    ...
			    <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="rylb"/>人员类别</dt>
			     <dd><select class="easyui-combobox" id="rylb" name="rylb" data-options="height:26,width:140,panelHeight:'auto'"></select>
<!-- 					<a -->
<!-- 						href="javascript:termcustaddall();" -->
<!-- 						class="easyui-linkbutton" -->
<!-- 						style="height: 26px; width: 125px;">查询并保存</a> -->
               ...
               <dl> 
				...
				<dd>
                   ...
                   value: '女'}]"></select>
					...
					<dd>
					 <input id="chkItem" name="chkItem" type="checkbox" checked value="isnotpay"/>含弃检项
					 <input id="chkItem" name="chkItem" type="checkbox" value="isyesitem"/>已检项目
