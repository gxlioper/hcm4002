...
function getteamExamInfoShowGrid() {
	...
	var model = {
		...
		"isprint":document.getElementsByName("isprint")[0].value,
	...
	$("#teamExamInfoShow").datagrid({
		url:'gettrjnExamInfoUsershow.action',
		dataType : 'json',
		queryParams : model,
		rownumbers : true,
		...
		columns : [[ 
		             ...
		             {align : 'center',field : 'acc_num',title : '结算号',width : 18},
		             {align : 'center',field : 'exam_num',title : '体检编号',width : 18}, 
		              ...
		              {align : 'center',field : 'createdate',title : '结算日期',width : 15},
		              {align : 'center',field : 'printflag',title : '打印',width : 15},
		              {align : 'center',field : 'printdate',title : '打印日期',width : 15},
		              ]],
...
function termtrjndo(ids){
		 ...
		 $.messager.confirm('提示信息','是否确定对所选人员执行取消结算操作？',function(r){
			 	if(r){
			 		var str = '<div class="loading_div" style=" position:fixed; background-image:url(../../images/bg_tm.png); left:0;top:0; overflow:hidden; width:100%; height:100%; display: block; z-index: 89999; ">' + '<div style="width:70px;  height:75px; margin-top:-38px; position:absolute; top:50%; left:50%; margin-left:-35px;"><img src="../../images/loading.gif" width="70" height="75" /></div></div>';
					 $("body").prepend(str);
		 $.ajax({
				url : 'termtrjndeldo.action',
				data : {ids:ids},
						type : "post",//数据发送方式   
