		...
		<div class="user-query">
			<dl>
               ...
               <dl>
				...
				<dd>
				    <select class="easyui-combobox" id="exam_status" name="exam_status"	data-options="multiple:true,height:26,width:140,panelHeight:'auto' ,valueField: 'value',textField: 'label',data: [{  
                   label: '未报到',  
                   value: 'Y',  
                   selected:true},{  
                   label: '已登记',  
			    ...
			    <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="rylb"/>人员类别</dt>
			     <dd><select class="easyui-combobox" id="rylb" name="rylb"
					data-options="height:26,width:180,panelHeight:'auto'"></select>
