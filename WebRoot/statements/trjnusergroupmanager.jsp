...
<script type="text/javascript" src="<%=request.getContextPath()%>/statements/trjnusergroupmanager.js?randomId=<%=Math.random()%>"></script>
			...
			<dl>
			 ...
			 <dt style="height:26px;width:70px;">体检任务</dt>
			    ...
			    <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" checked type="checkbox" value="join_date"/>报道日期</dt>
                     ...
                     <dt style="height:26px;width:50px;">至</dt>
