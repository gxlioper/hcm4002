...
<script type="text/javascript" src="<%=request.getContextPath()%>/statements/statementsMain.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="isunovertype" value="<s:property value="model.isunovertype"/>">
<input type="hidden" id="is_show_team_settlement_toolbar" value="<s:property value="model.is_show_team_settlement_toolbar"/>">
...
<legend><strong>结算信息</strong></legend>
 ...
 <div id="dlg-hsprintln" class="easyui-dialog"  data-options="width: 750,height: 420,closed: true,cache: false,modal: true,top:50"></div>
  <div id="dlg-fjfy" class="easyui-dialog"  data-options="width: 400,height: 320,closed: true,cache: false,modal: true,top:50"></div>
