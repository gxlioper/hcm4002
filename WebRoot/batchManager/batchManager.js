	...
	$('#compantmanager').tabs({
	    ...
	    if (!$('#compantmanager').tabs('exists', bat_string1)) {
	        $('#compantmanager').tabs('add', {
	            title: bat_string1,
	            content: '<iframe scrolling="auto" width="100%" align="center" id="icompanyedit" name="icompanyedit" onload="Javascript:SetWinHeightinn(this)" frameborder="0"  src="batchshow.action"></iframe>',
	            closable: false
	        });
	    }      
