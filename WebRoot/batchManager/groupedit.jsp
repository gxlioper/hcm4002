...
<script type="text/javascript" src="<%=request.getContextPath()%>/batchManager/groupedit.js?randomId=<%=Math.random()%>"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			...
			<dt>分组最大金额</dt>
			<dd>
				<input maxlength="20" class="easyui-textbox" type="text" id="maximum_amount"
					value="<s:property value="model.maximum_amount"/>"
		...
		<dl>
		  <dt>人员类别</dt>
			...
			<dd>
				<input  maxlength="20" type="text" id="amount"
					value="<s:property value="model.amount"/>"
					style="height: 26px; width: 115px;" /><span id="amount_yuan">(元)</span>
					&nbsp&nbsp&nbsp&nbsp&nbsp
			<input name="isgroupitemflag" id="isgroupitemflag" type="checkbox" checked="checked" value="1" onclick="isgroupitemdo();"/>在修改分组时,是否对已分组的预约人员同步项目
			</dd>
		</dl>
	</div>
</fieldset>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div id="main">
		...
		<div id="right">
			收费项目数量：<span id="commonType"></span> 项
