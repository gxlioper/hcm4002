(function($) {
    $.addFlex = function(t, p) {
        ...
        p = $.extend({
            ...
            title: false,
            pagestat: '第 {from} 至 {to}条, 共{total}条记录',
            pagetext: '跳到',
            outof: '共',
            findtext: 'Find',
        ...
        var g = {
            ...
            addData: function(data) {
                ...
                if (p.dataType == 'xml') {
                    ...
                    $(t).attr("pageno",data.page);
                    $(t).attr("pagetotal",data.total);
                    $(t).attr("pagesize",data.rp);
                }
                if (p.total == 0) {
    ...
    $.fn.noSelect = function(p) {
        ...
        if (prevent) {
            return this.each(function() {
                if ($.browser.msie || $.browser.safari) $(this).bind('selectstart',
                function() {
                    return false
                });
                    ...
                    $('body').trigger('focus')
                } else if ($.browser.opera) $(this).bind('mousedown',
                function() {
                    return false
                });
