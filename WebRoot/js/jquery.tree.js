...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                ...
                datatype: "json",
                url: false,
                cbiconpath: "themes/default/ecard/images/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (deep == 1) {
                ht.push("<img class='bbit-tree-icon' src='themes/default/ecard/images/s.gif'/>");
            }
            else if (deep > 1) {
            
                ht.push("<img class='bbit-tree-icon' src='themes/default/ecard/images/s.gif'/>");
                for (var j = 1; j < deep; j++) {
                    ht.push("<img class='bbit-tree-elbow-line' src='themes/default/ecard/images/s.gif'/>");
                }
            }
            ht.push("</span>");
            //img
            ...
            ht.push("<img class='bbit-tree-ec-icon ", cs.join(" "), "' src='themes/default/ecard/images/s.gif'/>");
            ht.push("<img class='bbit-tree-node-icon' src='themes/default/ecard/images/s.gif'/>");
            //checkbox
        ...
        function asnyloadc(pnode, isAsync, callback) {
            if (dfop.url) {
                ...
                if (pnode && pnode != null)
                {
                    ...
                    strrool="&root="+pnode.id
                 }
                $.ajax({
                    type: dfop.method,
                    url: dfop.url+strrool,
                    data: param,
                    async: isAsync,
