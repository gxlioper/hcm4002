...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/djtTTcustomeritemaddshow.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="djtlispacsflag" value="<s:property value="model.djtlispacsflag"/>">
