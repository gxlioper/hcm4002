...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/regetDjtRegisterGEdit.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="oldexam_id" value="<s:property value="model.exam_id"/>">
<input type="hidden" id="exam_num1" value='' >
...
<input type="hidden" id="feeresourceflag" value="<s:property value="model.feeresourceflag"/>">
  ...
  <tr>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>		    
			...
			<dt style="height:26px;width:80px;">备注</dt>
			<dd>
				<input class="easyui-textbox" type="text" maxlength="50"  id="remark"
					style="height: 26px; width: 140px;"  value="<s:property value="model.remarke" />"/>
			</dd>		
		</dl>
	</div>
</fieldset>
...
<fieldset style="margin: 5px; padding-right: 0;">
	<legend>
	  ...
	  <dl>
	  <dt>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:examnumenterbd();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:70px;">报道</a></dt>
