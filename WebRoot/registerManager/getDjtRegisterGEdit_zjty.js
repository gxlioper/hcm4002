...
//	        	delids.push(item.charge_item_id);
	...
	function djtaddcusItem(){
		...
		if($('exam_num').val()!=""){
 	    	var url='djtcustomeritemaddshow.action?exam_num='+$('#exam_num').val()+'&exam_id='+$("#exam_id").val()+'&sex='+scustsex+'';
 ...
 * +++++++++++++++++++++++++++++++上传体检信息+++++++++++++++++++++++++++++++++++++++++++++++++
 */
function getExaminfoSetSS(){
	if(document.getElementById("exam_num").value==""||document.getElementById("exam_num").value==0){
