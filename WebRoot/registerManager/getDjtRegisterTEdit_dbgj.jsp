...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterTEdit_dbgj.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="arch_num" value="0">
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="fnewsignt();"  value="签名"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a  href="javascript:void(0)" onClick="jzkread_cardno();"><img style="height:25px;width:25px;"  title="就诊卡获取人员信息" src="<%=request.getContextPath()%>/themes/default/images/bendi.jpg" /></a></td>
    <td><a href="javascript:void(0)" onClick="sfzread_cardno();"><img  title="身份证获取挂号信息" style="height:25px;width:25px;" src="<%=request.getContextPath()%>/themes/default/images/pic.jpg" /></a></td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			<dt style="height:26px;width:65px;">卡号</dt>
			<dd>
			<input type="text" id="card_num" value="" style="height:23px;width:214px;"/>
			<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="fnewkh();"  value="查询">
		...
		<dl>
			...
			<dd>
				<input class="textinput" maxlength="10"  maxlength='10'  type="text" id="exam_num"
					style="height: 23px; width: 85px;ime-mode: disabled;" value="<s:property value="model.exam_num" />"/>
			</dd>
			<dt style="height:26px;width:73px;">身份证号 </dt>
			<dd>
				<input class="textinput" maxlength="18" type="text"  onblur="selectidnum()" id="id_num" 
		...
		<dl>
			...
			<dt style="height:26px;width:80px;">出生日期</dt>
		...
		<dl>
			...
			<dd>
				<input class="easyui-textbox" type="text" maxlength="20"  id="employeeID"
					style="height: 26px; width:80px;" value="<s:property value="model.employeeID" />"/>
			</dd>
		...
		<dl>	
		    <dt style="height:26px;width:50px;">行业</dt>
			<dd><select class="easyui-combobox" id="occusectorid" name="occusectorid" panelMaxHeight="100px"  data-options="height:26,width:80,panelHeight:'auto'"></select></dd>
			<dt style="height:26px;width:80px;">选择分组<strong class="quest-color">*</strong></dt>
		...
		<dl>
			...
			<dd>
				<select class="easyui-combobox" id="reportingWay" name="reportingWay"data-options="height:26,width:120,panelHeight:'auto'">
		...
		<dl>
			...
			<dd>
				<input class="easyui-textbox" type="text" maxlength="20"  id="others"
					style="height: 26px; width:310px;" value="<s:property value="model.others" />"/>
			</dd>
		</dl>	
		<dl>		    
		...
		<dl>		    
			...
			<dd>
				<input class="easyui-textbox" type="text" maxlength="50"  id="remark"
					style="height: 26px; width: 310px;"  value="<s:property value="model.remark" />"/>
			</dd>			
		</dl>
	</div>
</fieldset>
...
<fieldset style="margin: 5px; padding-right: 0;">
	<legend>
	   ...
	   <dl>
			...
			<!-- dt>&nbsp;&nbsp;<a href="javascript:djtchagecusItem();"  class="easyui-linkbutton" style="height:26px;width:45px;">换项</a></dt-->
			<dt><a href="javascript:djtcustomerguahao();"  class="easyui-linkbutton" style="height:26px;width:45px;">挂号</a></dt>
			<dt>&nbsp;&nbsp;<a href="javascript:djtcustomerguahaojb();"  class="easyui-linkbutton" style="height:26px;width:80px;">医保挂号</a></dt>
	  </dl>
	  <dl>
			...
			&nbsp;<input name="ishisflags" type="checkbox" checked value="1"/>自动发送收费申请
		    </dt>
	  </dl>
	</fieldset>
