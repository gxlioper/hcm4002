...
function IdCard(UUserCard,num){
	...
	function checkinput() {	
		...
		if($('#idnum_notnull').val() == "Y" && document.getElementById("id_num").value==""){
			alert('身份证号不能为空！');
			return false;
		}
	...
	function printbarshow(){
		...
		$("#dlg-show").dialog({
	 		title:'打印导检单',
	 		href:'djtGprintbarshow.action?exam_num='+$('exam_num').val()+'&exam_id='+$("#exam_id").val()+'&exam_num'+$("#exam_num").val()
	 	});
	 	$("#dlg-show").dialog('open');
	 	}
	}
