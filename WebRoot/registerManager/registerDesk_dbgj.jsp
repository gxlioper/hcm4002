...
<legend><strong>信息检索</strong></legend>
				...
				<dl>
					...
					<dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="employeeID"/>工号</dt>					
					<dd><input class="easyui-textbox" type="text" id="employeeID" value="" style="height:26px;width:100px;"/></dd>
					<input name="isprintdjd" type="checkbox" checked value="1"/>报到打导检单
				</dl>
				...
				<dl>
				   <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="arch_num"/><s:text name="dahname"/></dt>					
					...
					data-options="height:26,width:100,panelHeight:'auto'"></select></dd>
					<input name="isprintdah" type="checkbox" checked value="1" />打印档案号
                </dl>
                <dl>
                	<dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="com_Name"/>选择单位</dt>					
					<dd><input class="easyui-textbox"  type="text" id="com_Name" value="" style="height:26px;width:100px;"/>
                    ...
                    <dt style="height:26px;width:60px;"><input id="chkItem" name="chkItem" type="checkbox" value="batch_Name"/>任务</dt>					
					<dd>
						 <select class="easyui-combobox" id="batch_ids"	data-options="height:26,width:135,panelHeight:'auto'"></select>
                    </dd>
                   
					<dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="set_id"/>体检套餐</dt>					
					 <dd><select class="easyui-combobox" id="set_id" data-options="height:26,width:240"></select></dd>
                    ...
                    <dd><select class="easyui-combobox" id="statusss" name="statusss"
						data-options="height:26,width:115,panelHeight:'auto'"></select></dd>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/registerDesk_dbgj.js?randomId=<%=Math.random()%>"></script>