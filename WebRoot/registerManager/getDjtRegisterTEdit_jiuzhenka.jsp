...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/jiuzhenkaCard.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterTEdit_jiuzhenka.js?randomId=<%=Math.random()%>"></script>

<body style="height:100%;">
<input type="hidden" id="idnum_notnull" value="<s:property value="idnum_notnull"/>">
<!-- 定义身份证设备 -->
...
<!-- 定义身份证设备结束 -->
<!-- 就诊卡 -->
<input type="hidden" id="Read_jiuzhenka" value="<s:property value="Read_jiuzhenka"/>">
<OBJECT ID='GWI_IC20AProj' <s:property value="Read_jiuzhenka_ocx"/> width='0' height='0'></OBJECT>
<!-- 就诊卡 -->
<!-- 拍照 -->
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;<!-- <input id="jiuzhenkaa"  style="height:26px;width:50px;" type="button" onclick="jiuzhengkaaPage();" value="就诊卡"> --></td>
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="fnewjkwjdc();"  value="问卷"></td>

  </tr>
  <tr>
     <td><a  href="javascript:void(0)" onClick="ttduqujiuzhneka()"><img style="height:25px;width:25px;" title="读取就诊卡" src="<%=request.getContextPath()%>/themes/al/img/jiuzhneka.png" /></a></td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			...
			<dd >
					<input   type="hidden" id="visit_no_h"  value = ""<s:property value='visit_no'/>  /> 
					<input   type="text" id="visit_no_j"  onkeydown="huiche()"   onblur="jiuzhengkayanzhen.alertyanzheng()" class="textinput"
					 value = ""<s:property value='visit_no'/>   style="height: 26px; width: 87px;" />
			</dd>
			<dt style="height:26px;width:75px;">证件类型</dt>
			<dd>
		...
		<dt style="height:26px;width:50px;">档案号</dt>
			...
			<dd>
				<input class="textinput"   type="text" maxlength="18"  onblur="selectidnum()" id="id_num" 
		...
		<dt style="height:26px;width:50px;">体检号</dt>
			<dd>
				<input class="textinput" maxlength="10"  type="text" id="c_exam_num"
...
<fieldset style="margin: 5px; padding-right: 0;">
	<legend>
	  ...
	  <dl>
			...
			&nbsp;<input name="isprintdah" type="checkbox" value="1"/>档案号  
			&nbsp;<input name="ishisflags" type="checkbox" checked="checked" value="1"/>自动发送收费申请
		    </dt>
	  </dl>
	</fieldset>
