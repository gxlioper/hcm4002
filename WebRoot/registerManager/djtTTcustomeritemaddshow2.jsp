...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/djtTTcustomeritemaddshow2.js?randomId=<%=Math.random()%>"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div id="main">
			...
			套餐列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="textinput" id="tclist"
	...
	<form id="add1Form">
		...
		<div class="formdiv fomr3" style="padding-top:30px;">
			<dl>
				...
				<dd><input type="text" class="textinput" name="introducer" id="introducer" value="" style="width:150px; height: 28px;"/> <strong class="red">*</strong></dd>
			</dl>
		</div>
		</div>
