...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/regetDjtRegisterTEdit.js?randomId=<%=Math.random()%>"></script>
  ...
  <tr>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			...
			<dd>
				<input class="easyui-textbox" missingMessage="可输入项" invalidMessage="最大长度不能超过20"  type="text" id="exam_num"
					style="height: 23px; width: 85px;" data-options="validType:'maxLength[20]'" />
			</dd>
		...
		<dl>	
			...
			<dd><select class="easyui-combobox" id="levelss" name="levelss"	data-options="height:26,width:130,panelHeight:'auto'"></select></dd>
