...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/plugins/jquery.easyui.min.js?randomId=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/easyui-lang-zh_CN.js"></script>  
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/common.js?randomId=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/djtTTcustomeritemaddshow3.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden"  id="group_id" value="<s:property value = 'group_id'/>" />
<input type="hidden" id="is_show_discount" value="<s:property value="model.is_show_discount"/>">
<input type="hidden"  id="maximumAmount" value="0" />
...
<div id="dlg-item-copy" class="easyui-dialog"  data-options="width:800,height:510,closed: true,cache: false,modal: true,top:50"></div>
