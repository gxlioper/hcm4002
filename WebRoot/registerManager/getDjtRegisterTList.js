	...
	$('#getDjtRegisterTList').tabs({
	    ...
	    if (!$('#getDjtRegisterTList').tabs('exists', bat_string1)) {
	        $('#getDjtRegisterTList').tabs('add', {
	            title: bat_string1,
	            content: '<iframe scrolling="auto" width="100%" align="center" id="igetDjtRegisterTEdit"   onload="Javascript:SetWinHeightinn(this)" name="igetDjtRegisterTEdit" frameborder="0"  src="getDjtRegisterTEdit.action?exam_num='+$("#exam_num").val()+'"></iframe>',
	            closable: false
	        });
	    }      
