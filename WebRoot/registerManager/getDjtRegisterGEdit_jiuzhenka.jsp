...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterGEdit_jiuzhenka.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
     <td><a  href="javascript:void(0)" onClick="duqujiuzhneka()"><img style="height:25px;width:25px;" title="读取就诊卡" src="<%=request.getContextPath()%>/themes/al/img/jiuzhneka.png" /></a></td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			...
			<dd >
					...
					<input   type="text" id="visit_no_j"     onblur="jiuzhengkayanzhen.alertyanzheng()" class="textinput"
		...
		<dl>
			...
			<dd>
				<input class="textinput"  type="text"  onblur="selectidnum()" id="id_num" 
		...
		<dt style="height:26px;width:50px;">体检号</dt>
			<dd>
				<input class="textinput" maxlength="11"  type="text" id="c_exam_num"
					style="height: 26px; width: 87px;ime-mode: disabled;"  value="<s:property value="model.exam_num" />"/>
			</dd>
		...
		<dl>
			...
			<dt style="height:26px;width:80px;">既往史</dt>
			<dd>
				<input class="easyui-textbox" type="text" maxlength="50"  id="past_medical_history"
					style="height: 26px; width: 140px;"  value="<s:property value="model.past_medical_history" />"/>
			</dd>			
		</dl>
		<dl>		    
