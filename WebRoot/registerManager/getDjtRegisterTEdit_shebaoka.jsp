...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterTEdit_shebaoka.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td><a  href="javascript:void(0)" onClick="duqushebaoka()"><img style="height:25px;width:25px;" title="读取社保卡" src="<%=request.getContextPath()%>/themes/al/img/jiuzhneka.png" /></a></td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			<dt style="height:26px;width:50px;">社保卡</dt>
			<dd >
				<input  class='textinput' type="text"   id="membership_card" 
					style="height: 26px; width: 95px;" value="<s:property value="model.membership_card" />"/>
			</dd>
		...
		<dt style="height:26px;width:50px;">体检号</dt>
			<dd>
				<input class="textinput" maxlength="12"  type="text" id="exam_num"
