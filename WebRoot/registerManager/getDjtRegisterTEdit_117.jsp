...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterTEdit_117.js?randomId=<%=Math.random()%>"></script>
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			<dt style="height:26px;width:160px;"></dt>
			<dd >
			</dd>
		...
		<dt style="height:26px;width:50px;">档案号</dt>
			<dd>
				<input class="textinput" type="text" id="arch_num"
		...
		<dt style="height:26px;width:50px;">体检号</dt>
			<dd>
				<input class="textinput" maxlength="10"  type="text" id="exam_num"
