...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterTEdit_zjty.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:70px;" type="button" onclick="fnewbingah();"  value="档案同步"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="getExaminfoSet();"  value="问卷"></td>
		...
		<dl>		    
			...
			<dd>
				<input class="easyui-textbox" type="text" maxlength="50"  id="remark"
					style="height: 26px; width: 160px;"  value="<s:property value="model.remark" />"/>
			</dd>
			<dt style="height:26px;width:70px;">预算金额</dt>
			<dd><input class="easyui-textbox" type="text" maxlength="20"  id="budget_amount"
					style="height: 26px; width:70px;" value="<s:property value="model.budget_amount" />"/>
			</dd>			
		</dl>
	</div>
</fieldset>
