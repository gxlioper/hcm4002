...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/djtdiscountaddshow.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="login_name" value="<s:property value="model.login_name"/>">
<!--资源  -->
<%-- <input type="text"  id="web_Resource" value="<s:property value = 'web_Resource'/>" /> --%>
