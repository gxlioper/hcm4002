...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterGEdit_dbgj.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="arch_num" value="">
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="fnewsigng();"  value="签名"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a  href="javascript:void(0)" onClick="jzkread_cardno();"><img  title="就诊卡获取挂号信息" style="height:25px;width:25px;" src="<%=request.getContextPath()%>/themes/default/images/bendi.jpg" /></a></td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			...
			<dd>
				<input class="textinput" maxlength="11"  type="text" id="exam_num"
					style="height: 26px; width: 87px;ime-mode: disabled;" data-options="validType:'maxLength[11]'" value="<s:property value="model.exam_num" />"/>
			</dd>
		...
		<dl>
		   ...
		   <dl>
			...
			<input id="chkItem" name="is_after_pay" checked="true" type="radio" value="N"/>前付费</dt>
			<input id="chkItem" name="is_after_pay"  type="radio" value="Y"/>后付费</dt>
			</dd>	         		
		</dl>
        <dl>
		...
		<dl>			
			<dt style="height:26px;width:50px;">&nbsp;</dt>
			<dd style="height:25px;width:80px;">
			   <input style="height:25px;width:80px;" type="button" onclick="customerguahao();" value="手工挂号">			
			</dd>
			<dt style="height:26px;width:80px;">门诊号</dt>
			<dd>
		...
		<dl>			
			<dt style="height:26px;width:50px;">就诊号</dt>
			<dd>
				<input class="easyui-textbox" readonly type="text" maxlength="20"  id="visit_no"
					style="height: 26px; width:80px;" value="<s:property value="model.visit_no" />"/>
			</dd>
			<dt style="height:26px;width:80px;">就诊日期</dt>
			<dd>
				<input class="easyui-textbox" type="text" maxlength="20" readonly  id="visit_date" 
					style="height: 26px; width: 140px;" value=""/>
			</dd>	
		</dl>
		<dl>
