...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/djtTGcustomeritemaddshow3.js?randomId=<%=Math.random()%>"></script>
...
<s:else>	**<input type="hidden" id="amount"
			...
			<dd>
			<a href="javascript:djtcustadd();" class="easyui-linkbutton c6" style="width:80px;">保存</a>
