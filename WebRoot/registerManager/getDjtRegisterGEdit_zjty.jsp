...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/getDjtRegisterGEdit_zjty.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="isprivateflag" value="<s:property value="model.isprivateflag"/>">
 ...
 <table width="240px" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;<input id="yynewbutton"  style="height:26px;width:50px;" type="button" onclick="getExaminfoSetSS();"  value="问卷"></td>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dt style="height:26px;width:50px;"><s:text name="tjhname"/></dt>
			<dd>
				<input class="textinput" maxlength="11" type="text" id="c_exam_num"
					style="height: 26px; width: 87px;ime-mode: disabled;"  value="<s:property value="exam_num" />"/>
			</dd>
		...
		<dl>		    
			...
			<dd><input class="easyui-textbox" type="text" maxlength="20"  id="budget_amount"
					style="height: 26px; width:120px;" value="<s:property value="model.budget_amount" />"/>
			</dd>		
		</dl>
		<dl>
