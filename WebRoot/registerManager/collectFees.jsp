...
<script type="text/javascript" src="<%=request.getContextPath()%>/registerManager/collectFees.js?randomId=<%=Math.random()%>"></script>
				...
				<span style="float: left; font-size: 16px; margin-top: 8px;">收费方式：</span>
					...
					<div class="user-query" style="font-size:16px;margin-top:3px;float: left;">
						...
						<dl style="margin-top:20px;margin-left:">
							<dd><a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:70px;" onclick="javascript:shoufeiBaodao();">收费</a></dd>
