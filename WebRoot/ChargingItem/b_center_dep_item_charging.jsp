...
<script type="text/javascript" src="<%=request.getContextPath()%>/ChargingItem/b_center_dep_item_charging.js"></script>
		...
		<legend><strong>收费项目查询</strong></legend>
			<div class="user-query">
				...
				<dl>
					...
					<dd><a href="javascript:b_getgroupuserGrid();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="width:100px;height:30px;">查询</a></dd>
				</dl>
			</div>
		 </fieldset>
		 <fieldset style="margin:5px;padding-right:0;height:60%;width: 98.5%">
