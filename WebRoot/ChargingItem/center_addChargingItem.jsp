...
<script type="text/javascript">
	...
	function addchargingItemdo() {
		...
		if ($('#chargitem_id').val() > 0) {
			...
			$.ajax({
				url : 'updateChargingItemCenter.action',
				type : 'post',
				data : {
					id : $('#chargitem_id').val(),
	 ...
	 * 获取所有检验样本
	 */
	function getItemSampleDemo() {
		var demoType;
		if($("#demo_type").val()=="" || $("#demo_type").val()==null ){
			demoType= 0 ;
		}else{
			demoType = $("#demo_type").val();
		}
		$('#addSampleDemo').combobox(
				{
					url : 'getItemSampleDemo.action?demo_type='+demoType,
					panelWidth : '250',
					panelHeight : '400',
					valueField : 'id',
					textField : 'demo_name',
					onLoadSuccess : function() {//下拉框默认选择
						...
						for ( var item in val[0]) {
							if (item == 'id') {
								//alert(item+"====="+$('#gSampleDemo').val());
								if (Number($('#gSampleDemo').val()) != 0) {
									$(this).combobox('select',Number($('#gSampleDemo').val()));//设置你找选中的
								}else {
									$(this).combobox('select', val[0][item]);//默认选择第一条
...
<fieldset style="margin: 10px; border-color: #3d85c6">
	...
	<div class="formDiv"
		...
		<dl style="height: 24px;">
			...
			<dd>
				<input type="text" class="textinput" id="additem_abbreviation" disabled="disabled"
			...
			<dd>
				<input type="hidden" id="gdep_id"
					value="<s:property value='dep_id'/>" /> <input type="text"  disabled="disabled"
		...
		<dl style="height: 24px">
			...
			<dd>
				<input type="text" id="additem_name" onkeydown="itemNameKeyDown()" maxlength="45"   disabled="disabled"
		...
		<dl style="height: 24px">
			...
			<dd>
				<input type="text" id="additem_pinyin" maxlength="45"   disabled="disabled"
			...
			<dd>
				<input type="hidden" id="demo_type"value="<s:property value='model.demo_type'/>" /> 
				<input type="text"class="textinput" id="addDemo_type" style="height: 26px; width: 160px;" disabled="disabled" />
			</dd>
		</dl>
		<dl style="height: 24px">
			<dt style="width: 110px">项目顺序码:</dt>
			<dd>
				<input type="text" class="textinput" id="additem_seq" disabled="disabled"
			...
			<dd>
				<input type="hidden" id="gSampleDemo" 
					value="<s:property value='sam_demo_id'/>" /> <input type="text"   disabled="disabled"
		...
		<dl style="height: 24px">
			...
			<dd style="width: 160px">
				<input type="radio" name="sex" id="sexQ" checked="checked"  disabled="disabled"
					value="全部" class="textinput" /> 全部&nbsp;&nbsp; <input type="radio"   disabled="disabled"
					name="sex" id="sexN" value="男" class="textinput" /> 男&nbsp;&nbsp;
				<input type="radio"  disabled="disabled" name="sex" id="sexY" value="女" class="textinput" />
				女&nbsp;&nbsp;
			</dd>
			...
			<dd>
				<input type="hidden" id="gSampleReportDemo"  
					value="<s:property value='sam_report_demo_id'/>" /> <input  disabled="disabled"
		...
		<dl style="height: 24px">
			...
			<dd style="width: 160px; height: 26px">
				<input type="radio" name="item_category" id="item_categoryP"   disabled="disabled"
					checked="checked" value="普通类型" /> <font
					style="text-align: center;">普通类型</font> <input type="radio"
					name="item_category" id="item_categoryH"   disabled="disabled" value="耗材类型" /> 耗材类型
			</dd>
		...
		<dl style="height: 24px">
			<dd>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="hidden"
					...
					id="isOnlyApplyOrReport" value="Y"  disabled="disabled"  />
			</dd>
			<dt style="width: 151px">产生独立申请单</dt>
			<dt style="width: 155px">核算金额</dt>
			<dd>
				<input type="text" class="textinput" id="addcalculation_amount"
					value="<s:property value='calculation_amount'/>"
					style="height: 26px; width: 160px;" />
			...
			<dd>
				<input type="hidden" id="gitem_type"
					value="<s:property value='item_type'/>" /> <input type="text"   disabled="disabled"
		...
		<dl style="height: 24px">
			...
			<dd>
				<input type="hidden" id="yguide_category"
					value="<s:property value='guide_category'/>" /> <input type="text"  disabled="disabled"
		...
		<dl style="height: 24px">
				...
				<dd>
					<input type="hidden" id="h_finance_class"
						value="<s:property value='finance_class'/>" /> <input  disabled="disabled"
				...
				<dd>
				<dt style="width: 126px">HIS项目类别</dt>
				<dd>
					<input type="hidden" id="item_class"
						value="<s:property value='item_class_c'/>" /> <input type="text"  disabled="disabled"
			...
			<dl>
			 	...
			 	<dt style="width: 126px">统一价格</dt>
				<dd>
					<input type="text" class="textinput" 
						value="<s:property value='price'/>" disabled="disabled"  style="height: 26px; width: 160px;" /> 
				</dd>
			</dl>
	</div>
	<div style="float: right; width: 22%; padding-left: 0px;"
		...
		<dl style="height: 100px; padding-left: 0px;">
			...
			<dd>
				<%-- <input type="text" class="textinput" id="item_note"
					value="<s:property value='item_note'/>"  style="height: 26px; width:160px;"/>  --%>
				<textarea style="height: 100px;" disabled="disabled" id="item_note"><s:property
		...
		<dl style="height: 100px; padding-left: 0px;">
			...
			<dd>
				<textarea style="height: 95px;" disabled="disabled" id="remark"><s:property
...
<%-- 		<legend>
		...
		<div style="float:left; width: 49.5%; margin-top: 2px">
			<div style="height: 29px">
				<span style="font-size: 16px;">检查项目清单</span>
			</div>
