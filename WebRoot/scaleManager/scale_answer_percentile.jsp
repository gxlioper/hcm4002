...
<script type="text/javascript" src="<%=request.getContextPath()%>/scaleManager/scale_answer_percentile.js?randomId=<%=Math.random()%>"></script>
<style>
.bkground {
...
<input type="hidden" id="full_score" value="<s:property value="full_score"/>"/>
