...
<script type="text/javascript" src="<%=request.getContextPath()%>/scaleManager/quest_answer.js"></script>
<style type="">
	#xiaLa .panel-title{
		font-size: 13px;
	}
...
<body>
	<fieldset style="margin:5px;padding-right:0;">
		...
		<div class="user-query">
			<dl>
				<dd>体检号：<input type="text" style="width:85px" id="exam_num" value="<s:property value="exam_num"/>" class="textinput easyui-textbox"/></dd>
		...
		<div class="easyui-layout" fit="true" style="margin:5px;">
		    <div data-options="region:'west',split:true" title="<span id='title_biao'>问卷类型</span>" style="width:150px;">
		    	<div id="xiaLa"></div>
			</div>
		    <div  data-options="region:'center',title:''">
		    	<p> 
					<h3 style="margin:16px 0px 15px 13px;display: none">当前位置    >>  
