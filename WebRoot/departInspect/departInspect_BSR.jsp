...
<script type="text/javascript" src="<%=request.getContextPath()%>/departInspect/departInspect_BSR.js?randomId=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/departInspect/departInspect_BSR_bone.js?randomId=<%=Math.random()%>"></script>
...
<input type="hidden" id="userid" value="<s:property value="#session.username.userid"/>"/>
	<div  style="height:100%;width:25%" data-options="region:'west'">
				<fieldset class="customersize" style="margin:5px;margin-left :0px;padding-right:20px;height:55%;padding-left:30px;margin-left:3px;">
                ...
                <s:else><span id="vipsigin"  style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;<font size="4" color="red">★★★★★</font></span></s:else> 
					...
					<div class="user-query" style="margin-left:-20px;padding-right: 0px;">
						...
						<dl>
							<dt style="width:60px;"><s:text name="tjhname"/>：</dt><dt style="width:80px;ime-mode: disabled;"  id="tjh"><s:property value='exam_num'/></dt>
						</dl>
						<dl>
							<dt style="width:60px;">姓名:       </dt><dt style="width:70px;"><s:property value='user_name'/></dt>
						</dl>
						<dl>
							<dt style="width:60px;">性别：   </dt><dt id="sex" style="width:70px;"><s:property value='sex'/></dt>
						</dl>
						<dl>
							<dt style="width:60px;">年龄：    </dt><dt id="age" style="width:70px;"><s:property value='age'/></dt>
						</dl>
						<dl>
							<dt style="width:60px;">单位：     </dt><dt style="width:70%"><s:property value='company'/></dt>
						</dl>
						<dl>
							<dt style="width:90px;">人员类型:</dt><dt style="width:66%"><s:property  value='type_name'/></dt>
						</dl>
						<dl>
					...
					<div style="padding-right: 5px;height: 30px;text-align: right;bottom: 5px;">
		    			<a href="javascript:void(0)" onclick="keshicaiyang();" id="keshicy" class="easyui-linkbutton c6" style="width:120px;height:26px;display:none;">科室采样</a>
					</div>
	 			</fieldset>
 			...
 			<div data-options="region:'center'">
				...
				<div>
	    	   	...
	    	   	<div style="margin-top: 10px;">
	    	   		<ul class="views" style="width: 100%;">
	    	   			<li>
	    	   				<label>结论</label>
	    	   				<textarea  id="jielun" style="width: 160%;height: 200px;resize:none;margin-left: 160px;"></textarea>
	    	   			</li>
	    	   			<!-- 
	    	   			<li>
	    	   				<label>专科建议</label>
	    	   				<textarea id="zhuanjiaji" style="width: 60%;height: 200px;resize:none;margin-left: 10px;" ondblclick="zhuankejianyi_db();"></textarea>
	    	   			</li>
	    	   			 -->
	    	   		</ul>
	    	   	</div>
	    	   	<div>
	    	   		<br/>
	    	   		<br/>
	    	   		<strong style="width: 100%;margin-left: 60px;">====================================================公式====================================================</strong><br/><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">
	    	   		500频率矫正值：<input id="frequency500" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency500'/>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	   		1000频率矫正值：<input id="frequency1000" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency1000'/>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	   		2000频率矫正值：<input id="frequency2000" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency2000'/>"/>
	    	   		<!-- 
	    	   		语频矫正值：<input id="speech_frequency" disabled="disabled" size="1" value="<s:property value='correctionValue.speech_frequency'/>"/>
	    	   		 -->
	    	   		</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">
	    	   		3000频率矫正值：<input id="frequency3000" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency3000'/>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	   		4000频率矫正值：<input id="frequency4000" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency4000'/>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	   		6000频率矫正值：<input id="frequency6000" disabled="disabled" size="1" value="<s:property value='correctionValue.frequency6000'/>"/>
	    	   		<!-- 
	    	   		高频矫正值：<input id="hight_frequency" disabled="disabled" size="1" value="<s:property value='correctionValue.hight_frequency'/>"/>
	    	   		 -->
	    	   		</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">右耳语频平均听阈 = (矫正后右耳500 + 矫正后右耳1000 + 矫正后右耳2000) / 3</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">左耳语频平均听阈 = (矫正后左耳500 + 矫正后左耳1000 + 矫正后左耳2000) / 3</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">双耳高频平均听阈 = (矫正后右耳3000 + 矫正后右耳4000 + 矫正后右耳6000 + 矫正后左耳3000 + 矫正后左耳4000 + 矫正后左耳6000) / 6</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">右耳平均听阈加权值 = (矫正后右耳500 + 矫正后右耳1000 + 矫正后右耳2000)/3 x 0.9 + 矫正后右耳4000 x 0.1</p><br/>
	    	   		<p style="width: 100%;margin-left: 60px;">左耳平均听阈加权值 = (矫正后左耳500 + 矫正后左耳1000 + 矫正后左耳2000)/3 x 0.9 + 矫正后左耳4000 x 0.1</p><br/>
	    	   		<br/>
	    	   		<strong style="width: 100%;margin-left: 60px;">=============================================下方录入骨导方式结果=============================================</strong><br/>
  					<br/>
	    	   	</div>
	    	   	<div>
  					<ul id='dt_bone' class="views" onkeydown="keyDown(event)"></ul>
  				</div>
  				<div style="margin-top: 10px;">
	    	   		<ul class="views" style="width: 100%;">
	    	   			<li>
	    	   				<label>结论(骨导)</label>
	    	   				<textarea  id="jielun_bone" style="width: 160%;height: 200px;resize:none;margin-left: 160px;"></textarea>
	    	   			</li>
	    	   			<!-- 
	    	   			<li>
	    	   				<label>专科建议</label>
    ...
    <div data-options="region:'south'" style="height:55px;">
    	 <div class="sub_btn">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:90px;" onclick="javascript:tocriticalpage();">危急值信息</a>
