...
<script type="text/javascript" src="<%=request.getContextPath()%>/departInspect/departInspect.js?randomId=<%=Math.random()%>"></script>
	...
	<div  style="height:100%;width:25%" data-options="region:'west'">
                ...
                <s:else><span id="vipsigin"  style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;<font size="4" color="red">★★★★★</font></span></s:else> 
					...
					<div class="user-query" style="margin-left:-20px;padding-right: 0px;">
						...
						<dl>
							<dt style="width:60px;">年龄：    </dt><dt style="width:70px;"><s:property value='age'/></dt>
						</dl>
						<dl>
				    	...
				    	<div class="easyui-tabs" fit="true">
				    		<div title="危急值"  data-options="tabWidth:200,border:false">   
						        <%--<div id="weijizhi_div"></div>    --%>
									<div id="weijizhi_new"></div> <%-- 新危急值显示--%>
						    </div>   
