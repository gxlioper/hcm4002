 ...
 */
 function updataSampleReportDemoPage(id){
		...
		$("#dlg-custedit").dialog({
			title:'修改疾病自动生成逻辑',
			center:'center',
			href:'getDiseaseLogicSingleEditPage.action?ids='+id+'&dep_id='+dep_id+'&ran='+ Math.random()
		});
...
var toolbar = [ {
	...
	handler : function() {
		...
		$("#dlg-custedit").dialog({
			title : '新增单项阳性自动生成逻辑',
			center:'center',
			href : 'getDiseaseLogicSingleEditPage.action?dep_id='+obj.id,
		});
		$("#dlg-custedit").dialog('open');
		$("#dlg-custedit").dialog('center');
	}
