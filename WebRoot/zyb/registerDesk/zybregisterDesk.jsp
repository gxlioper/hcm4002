...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/zybregisterDesk.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>信息检索</strong></legend>
			<div class="user-query">
				<dl>
					...
					报到打<input name="isprintdjd" type="checkbox" checked value="1"/> 导检单&nbsp;
					<input name="isprinttm" type="checkbox" checked value="1"/>条码&nbsp;
                    <input name="isprintdah" type="checkbox" checked value="1"/>打档案号
				</dl>
				...
				<dl>
				   <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" type="checkbox" value="arch_num"/><s:text name="dahname"/></dt>					
                    ...
                    <dt style="height:26px;width:60px;"><input id="chkItem" name="chkItem" type="checkbox" value="employeeID"/>工号</dt>					
				...
				<dl>
					...
					data-options="height:26,width:80,panelHeight:'auto'"></select></dd>
					 ...
					 <dd><select class="easyui-combobox" id="set_id" data-options="height:26,width:180"></select></dd>
					<dd><a href="javascript:getgroupuserGrid();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="height:26px;width:45px;">查询</a></dd>
					<dd><a href="javascript:dosfzbd();"  class="easyui-linkbutton" style="height:26px;width:90px;">身份证报到</a></dd>
				</dl>
			</div>
 </fieldset>
 <fieldset style="margin:5px;padding-right:0;">
