...
<script  type="text/javascript" src="<%=request.getContextPath()%>/scripts/layui-v2.5.5/dist/xm-select.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/easyui-lang-zh_CN.js"></script>
<input type="hidden" id="zyb_exam_num" value="<s:property value="exam_num"/> ">
<input type="hidden" id="zyb_arch_num" value="<s:property value="arch_num"/> ">
...
<script  type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/djtcustomer_hazard.js"></script>
