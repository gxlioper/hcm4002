...
$(document).ready(function () {
	var userid=<s:property value="creater"/>; 
	var up=<s:property value="uploadURL"/>; 
    $('#file_upload').uploadify({
       ...
       'onSelect': function(e, queueId, fileObj)
        ...
        'onComplete': function(event, queueId, fileObj, response, data) {
        	...
        	uploadflag=0;
        	var b = eval("("+response+")")
        	if (b.message.split("-")[0] == 'ok') {
				$.messager.alert("操作提示",b.message);
				if("com/hjw/zyb/ZybUpload2"==up){
					getcusthisGrid();
				} else if("com/hjw/zyb/ZybUploadFS"==up){
					getFscusthisGrid();
				} else {
					getJWScusthisGrid();
				}
