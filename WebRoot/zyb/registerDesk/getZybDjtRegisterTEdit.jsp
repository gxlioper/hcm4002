...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/getZybDjtRegisterTEdit.js?randomId=<%=Math.random()%>"></script>
  ...
  <tr>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dt style="height:26px;width:50px;"><s:text name="tjhname"/></dt>
			<dd>
				<input class="easyui-textbox" missingMessage="可输入项" invalidMessage="最大长度不能超过15"  type="text" id="c_exam_num"
					style="height: 23px; width: 85px;" data-options="validType:'maxLength[15]'" value="<s:property value="model.exam_num" />"/>
			</dd>
