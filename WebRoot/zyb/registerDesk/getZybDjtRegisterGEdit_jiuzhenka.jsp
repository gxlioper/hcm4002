...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/getZybDjtRegisterGEdit_jiuzhenka.js?randomId=<%=Math.random()%>"></script>
  ...
  <tr>
    ...
    <td>&nbsp;<input id="clearbutton"  style="height:26px;width:50px;" type="button" onclick="clearcustomer();" value="清除"></td>
		...
		<dl>
			...
			<dd>
				<input class="textinput" invalidMessage="身份证必须18位"  type="text"  data-options="validType:'Length[18]',events:{blur:selectidnum}" id="id_num" 
		...
		<dt style="height:26px;width:50px;"><s:text name="tjhname"/></dt>
			<dd>
				<input class="textinput" invalidMessage="最大长度不能超过11"  type="text" id="exam_num"
