...
function djtTTaddcusItem() {
    ...
    if ($('#exam_num').val() == '') {
        ...
        var url = 'zybdjtTTcustomeritemaddshow.action?exam_num=' + $("#exam_num").val() + '&sex=' + scustsex + '&exam_indicator=' + $("#exam_indicator").val() + '';
        newWindow = window.open(url, "人员团体加项", "toolbar=no,location=no,fullscreen=yes,scrollbars=yes");
        newWindow.focus();
        //timer = setInterval("djtupdateAfterClose()", 1000);
    }
...
function djtTGaddcusItem() {
    ...
    if ($('#exam_num').val() == '') {
        ...
        var url = 'zybdjtTGcustomeritemaddshow.action?exam_num=' + $("#exam_num").val() + '&sex=' + scustsex + '&exam_indicator=' + $("#exam_indicator").val() + '';
