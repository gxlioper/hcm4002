...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/zybdjtcustomerGitemaddshow.js"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			...
			<dt id="zyb_zkl">折扣率</dt>
			<dd>
				<input  type="text" id="discount"
					value="10"
					style="height: 26px; width: 100px;" />
			</dd>
			<dt id="zyb_zkhze">折扣后总额</dt>
			<dd>
				<input type="text" id="amount"
					value="0"
					style="height: 26px; width: 110px;" /><span id="zyb_yuan">(元)</span>
			</dd>
			<dd>
