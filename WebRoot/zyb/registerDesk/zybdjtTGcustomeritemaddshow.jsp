...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/registerDesk/zybdjtTGcustomeritemaddshow.js"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			...
			<dt id="gr_zkhze">折扣后总额</dt>
			<dd>
				<input type="text" id="amount" readonly
					value="0"
					style="height: 26px; width: 70px;" /><span id="gr_yuan">(元)</span>
			</dd>
			<dt>单位结算总额</dt>
			<dd>
