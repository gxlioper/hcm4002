...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/customerManager/zybimpusershow_set.js?randomId=<%=Math.random()%>"></script>
			...
			<div class="user-query">
				<dl>
                    <dd style="height:20px;">
					  ...
					  <div id="com_name_list_div" style="display:none;margin-left:235px;" 
