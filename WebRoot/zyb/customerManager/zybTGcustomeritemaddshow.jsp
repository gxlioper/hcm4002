...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/customerManager/zybTGcustomeritemaddshow.js"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			...
			<dt id="grpt_zkl">折扣率</dt>
			<dd>
				<input  type="text" id="discount"
					value="10"
					style="height: 26px; width: 70px;" />
			</dd>
			<dt id="grpt_zkhze">折扣后总额</dt>
			<dd>
				<input type="text" id="amount" readonly
					value="0"
					style="height: 26px; width: 70px;" /><span id="grpt_yuan">(元)</span>
			</dd>
			<dt>个人结算总额</dt>
			<dd>
