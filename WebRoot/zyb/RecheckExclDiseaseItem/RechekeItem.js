	...
	/*   var str = '<div class="loading_div" style=" position:fixed; background-image:url(../../images/bg_tm.png); left:0;top:0; overflow:hidden; width:100%; height:100%; display: block; z-index: 89999; ">' + '<div style="width:70px;  height:75px; margin-top:-38px; position:absolute; top:50%; left:50%; margin-left:-35px;"><img src="../../images/loading.gif" width="70" height="75" /></div></div>';
		 ...
		 columns:[[
		        {field:'ck',checkbox:true},
			 	{align:'left',field:'check_item_ask',title:'复查项目及要求名称',width:30},
        	...
        	var row_id = $('#hazardfactorsShow').datagrid('getRows')[index].check_item_id;
...
//-------------------------------------修改职业体检类别页面---------------------
 function f_xg(val,row){	
	return '<a href=\"javascript:updateZYB_OccuphyexaPage(\''+row.check_item_id+'\')\"><img src=\"themes/default/images/blank.gif\" class=\"icon ico-edit\" alt=\"修改\" /></a>';
}
/**
 * 修改职业危害因素
 * @param id
 */
 function updateZYB_OccuphyexaPage(id){
			...
			height:240,
			center:'center',
			href:'updateCheckItemPage.action?check_item_id='+id,
		});
}
//------------------------------------删除职业病----------------------------------
function f_sc(val, row) {
	return '<a href=\"javascript:delete_lb(\''+row.check_item_id+'\')\"><img src=\"themes/default/images/blank.gif\" class=\"icon ico-delete\" alt=\"删除\" /></a>';
}
/**
 *批量删除复查项目及要求
 * @param id
...
function f_deluser(id) {
	...
	$.messager.confirm('确认','您确认要删除记录吗？',function(r){    
	    if (r){ 
	    	$.ajax({
	    		url : 'deleteCheckItem.action?ids='+id,
	    		type : 'post',
