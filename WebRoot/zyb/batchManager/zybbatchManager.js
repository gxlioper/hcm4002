	...
	$('#compantmanager').tabs({
	    ...
	    if (!$('#compantmanager').tabs('exists', bat_string1)) {
	        $('#compantmanager').tabs('add', {
	            title: bat_string1,
	            content: '<iframe scrolling="auto" width="100%" align="center" id="icompanyedit" name="icompanyedit" onload="Javascript:SetWinHeightinn(this)" frameborder="0"  src="zybbatchshow.action"></iframe>',
	            closable: false
	        });
	    }      
	    ...
	    /*if (!$('#compantmanager').tabs('exists', bat_string2)) {
	        $('#compantmanager').tabs('add', {
	            title: bat_string2,
	            content: '<iframe scrolling="auto" width="100%" align="center" id="icompanyedit" name="icompanyedit" onload="Javascript:SetWinHeightinn(this)" frameborder="0"  src="groupmanager.action"></iframe>',
	            closable: false
	        });
	    }
	    ...
	    if (!$('#compantmanager').tabs('exists', bat_string3)) {
	        $('#compantmanager').tabs('add', {
	            title: bat_string3,
	            content: '<iframe scrolling="auto" width="100%" align="center" id="icompanyedit" name="icompanyedit" onload="Javascript:SetWinHeightinn(this)" frameborder="0"  src="batchproShow.action"></iframe>',
	            closable: false
