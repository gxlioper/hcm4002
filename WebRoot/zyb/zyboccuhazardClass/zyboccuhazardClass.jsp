...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/zyboccuhazardClass/zyboccuhazardClass.js"></script>
<!--表格内容溢出---显示省略号样式  -->
<style type="text/css">
...
<input type="hidden"   id="intss"  value="<s:property value='intss'/>"/>
	...
	<legend><strong>职业危害类别查询</strong></legend>
				<div class="user-query" >
					<dl>
						<dt style="width:70px;">类别名称</dt>
						<dd>
							<input  type="text" class="textinput" id="hazardclass_name_c"    style="height:23px;width:140px;" />
						</dd>
						<dt style="width:70px;">类别编码</dt>
						<dd>
							<input  type="text" class="textinput" id="hazardclass_code_c"    style="height:23px;width:140px;" />
						</dd>
...
<legend><strong>职业危害类别列表</strong></legend> 
