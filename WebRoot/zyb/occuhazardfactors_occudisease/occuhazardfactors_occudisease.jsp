...
<script type="text/javascript" src="<%=request.getContextPath()%>/zyb/occuhazardfactors_occudisease/occuhazardfactors_occudisease.js"></script>
<!--表格内容溢出---显示省略号样式  -->
<%-- <style type="text/css">
.datagrid-btable .datagrid-cell{padding:6px 4px;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;}  
</style> --%>

<input type="hidden" id ="lbname"   value=""/>
<input type="hidden" id ="ysname"   value="" />
<body class="easyui-layout" style="height: 99%">
	<div data-options="region:'west',title:'危害因素',split:true" style="width:200px;">
    		<ul id="some_tree"></ul>
    </div>   
    <div data-options="region:'center',title:'职业病'" style="padding:5px;">
    		<div style="height:50px;padding-left: 40px;padding-top:15px;" >
				职业病名称<input type="text"  id='contraindication_name'  class = 'textinput'  style="height: 26px;"  />
