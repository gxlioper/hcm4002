...
function saveCashierDaily(){
	...
	$("body").prepend(str);
	$.ajax({
		url:'saveCashierDailyacc.action',
		type:'post',
...
function getcashierclasslist(daily_acc_num){
	...
	$("#dailyacclistclass").datagrid({
		url: 'getCashierDailyAccPayway.action',
		queryParams: model,
		rownumbers:true,
		columns:[[
...
function getcashierclasslistmx(daily_acc_num,daily_acc_class){
	...
	$("#dailyacclistclassmx").datagrid({
		url: 'getCashierDailyAccDetail.action',
		queryParams: model,
		rownumbers:true,
		columns:column,
	    onLoadSuccess:function(value){
...
function getcashierinvoice(num){
	...
	$("#dailyaccinvoicelist").datagrid({
		url: 'getCashierDailyAccInvoice.action',
		queryParams: model,
		rownumbers:true,
		columns:[[
