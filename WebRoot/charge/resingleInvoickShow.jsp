...
function getsingleInviockGrid(){
	...
	$("#bdsjsingleInviockList").datagrid({
...
//		          {align:"center",field:"cash_date","title":"收费日期","width":15}
	    ...
	    onLoadSuccess:function(value){
	    	...
	    	$('#bdsjsingleInviockList').datagrid('checkAll');
	    },
	    singleSelect:false,
	    collapsible:true,
		pagination: false,
...
function jineheji(){
	var data = $('#bdsjsingleInviockList').datagrid('getSelections');
...
<form id="add1Form">
	<div class="formdiv" style="height:200px;">
		<div id="bdsjsingleInviockList"></div>
	</div>
	<div class="formdiv">
		<div class="formdiv">
			<dl>
