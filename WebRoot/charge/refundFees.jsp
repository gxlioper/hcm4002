...
<script type="text/javascript" src="<%=request.getContextPath()%>/charge/refundFees.js?randomId=<%=Math.random()%>"></script>
...
<div id="toolbar">
		...
		<div><a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:70px;" onclick="javascript:tuifei_show(1);">退费</a>
				...
				<a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:120px;" onclick="javascript:zuofeifapiao();">作废发票/收据</a>
...
<div id="toolbar1">
		...
		<div><a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:70px;" onclick="javascript:tuifei_show();">退费</a>
			 ...
			 <a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:80px;" onclick="javascript:jiaofeishengqi();">缴费申请</a>
			 <a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:90px;" onclick="javascript:shouju_show();">补打收据</a>
...
<div id="dlg-shouju" class="easyui-dialog" data-options="width: 600,height: 558,closed: true,cache: false,modal: true,top:50"></div>
</body>
</html>