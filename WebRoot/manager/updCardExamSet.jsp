...
<script type="text/javascript" src="<%=request.getContextPath()%>/manager/updCardExamSet.js"></script>
<input type="hidden" id="cardNumList" value="<s:property value="model.card_num"/>">
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		<dl>
			...
			<dt id = "zkl">折扣率</dt>
			<dd>
				<input  type="text" id="discount" readonly value="10" style="height: 26px; width: 100px;" />
			</dd>
			<dt  id = "zkhze">折扣后总额</dt>
			<dd>
				<input type="text" id="amount" 
					value="0"
					style="height: 26px; width: 110px;" readonly /><span id = "yuan">(元)</span>
			</dd>
			<dd>
			 <a href="javascript:updCardExamSetItem();" class="easyui-linkbutton c6" style="width:70px;">保存</a>
