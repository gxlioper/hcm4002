...
function f_cardMembersave(type){
	var reg =/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|x|X)$/;
	var reg1 =/^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$/;
...
//	}
	$.ajax({
        url:'saveCardMember.action?language='+$("#language").val(),  
        data:{
          id:$("#id").val(),
          ...
          success: function(data){
        	  if(type == 1){
        		$.messager.alert('提示信息', data.split("-")[0],function(){});
            	 	...
            	 	$("#cardmemerlist").datagrid('reload');
        	  }else{
        		  $("#dlg-edit").dialog("close");
                	getGrid();
                	$("#card-edit").dialog({
          			title:'新增卡信息',
          			href:'cardInfoadd.action?member_id='+data.split("-")[1]
          		});
...
<div class="formdiv">
		<div class="formdiv fomr3" style="padding-top:20px;">
			<dl class="member">
				<dt><input type="hidden" name="id" id="id" value="<s:property value="arch_num"/>"/>姓名：</dt>
				<dd><input type="text" id="user_name" name="user_name" value="<s:property value="user_name"/>" class="textinput"/><strong class="red">*</strong></dd>
				<dt><input type="hidden" name="customer_id" id="customer_id" value="<s:property value="customer_id"/>"/>身份证号：</dt>
				<dd><input type="text" id="id_number" name="id_number" value="<s:property value="id_num"/>" class="textinput" /><strong class="red">*</strong></dd>
			...
			<dl>
				<dt>电话：</dt>
				<dd><input type="text" id="phone" name="phone" value="<s:property value="phone"/>" class="textinput" /></dd>
				<dt>邮箱：</dt>
				<dd><input type="text" id="email" name="email" value="<s:property value="email"/>" class="textinput" /></dd>
			</dl>
			<dl>
				<dt>民族：</dt>
				...
				<dt>地址：</dt>
				<dd><input type="text" id="address" name="address" value="<s:property value="address"/>" class="textinput" /></dd>
			</dl>
			<dl class="member">
				<dt>会员等级：</dt>
				...
				<dt>会员积分：</dt>
				<dd><input type="text" id="integral" name="integral" disabled="disabled" value="<s:property value="integral"/>" class="textinput" /></dd>
			</dl>
			<!--  <dl class="member">
				<dt>备注：</dt>
...
<div class="dialog-button-box">
	<div class="inner-button-box">
	    <a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:80px;" onclick="javascript:f_cardMembersave();">下一步</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:80px;" onclick="javascript:f_cardMembersave(1);">保存</a>
