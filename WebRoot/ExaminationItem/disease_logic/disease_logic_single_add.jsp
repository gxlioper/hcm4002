...
function add_tioajian(){
	...
	var str = '<fieldset class="tiaojian_id" style="margin-left:10px;height:270px;width:300px;float:left;">'
			 ...
			 +'<dl ><dd>是否危机：</dd><dt><select style="width: 60px;"><option value="0">否</option><option value="1">是</option></select></dt>'
			 +'<dd><input type="button" value="删除条件" onclick="del_tioajian(this);" style="width:80px;text-align: center;background:#6fa8dc;color:#ffffff;cursor: pointer;"/></dd></dl>'
 ...
 <fieldset style=" margin: 10px;padding-left: 0px">
	...
	<div class="user-query">
		<dl>
			<dt>检查项目：</dt>
			<dd>
                <input type="text" id='exam_item_name' class="textinput" disabled value="<s:property value='item_name'/>"/>
