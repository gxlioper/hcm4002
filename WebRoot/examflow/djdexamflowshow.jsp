...
<script type="text/javascript" src="<%=request.getContextPath()%>/examflow/djdexamflowshow.js?randomId=<%=Math.random()%>"></script>
</head>
<body>
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
			...
			<a href="javascript:selectexamflowsholist();" class="easyui-linkbutton" style="width:100px;">查询</a>
			</dl>
	</div>
</fieldset>
<fieldset style="margin: 5px; padding-right: 0;">
