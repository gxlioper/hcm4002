...
<script type="text/javascript" src="<%=request.getContextPath()%>/examflow/getAcceptanceItemDbgj.js?randomId=<%=Math.random()%>"></script>
    	...
    	<div class="easyui-layout" data-options="fit:true" border="false" style="margin-left:10px;">
    		<div data-options="region:'north'" border="false" style="height:94px;">
    			...
    			<legend><strong>信息检索</strong></legend>
					<div class="user-query">
						<dl>
							<dd><s:text name="tjhname"/>：<input type="text" style="width:85px;ime-mode: disabled;" id="ser_num" readonly="readonly" class="textinput" value="<s:property value="model.exam_num"/>"/></dd>
							...
							<dd><a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;height:27px;" onclick="javascript:window.close();">关闭</a></dd>
						...
						<dl>
							<dt style="width:50px;">姓名：<input type="hidden" name="exam_num" id="exam_num"/></dt><dt id="user_name" style="width:70px;"></dt>
			...
			<div data-options="region:'center'" style="position:relative">
				<div id="tt" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
       			...
       			<div style="width: 230px; height: 20px; position:absolute;top:0px;right:320px;">
	    	              发给<input id="user" required='true' />&nbsp;&nbsp;审核	    	    
	    	    </div>
       			<div style="width: 80px; height: 20px; position:absolute;top:0px;right:240px;" onclick="javascript:sendcheckdoc();">
       				<span class="easyui-linkbutton c6" style="width:80px;height:27px;" >发给</span>
       				<div id="dlg-report" class="easyui-dialog" data-options="width: 850,height: 552,closed: true,cache: false,modal: true,top:50">
       				</div>
       			</div>
       			
       			<div style="width: 80px; height: 20px; position:absolute;top:0px;right:40px;" onclick="javascript:exam_suggestion();">
       				<span class="easyui-linkbutton c6" style="width:80px;height:27px;" >预览意见</span>
       				<div id="dlg-report" class="easyui-dialog" data-options="width: 850,height: 552,closed: true,cache: false,modal: true,top:50">
       				</div>
       			</div>
       			<div style="width: 80px; height: 20px; position:absolute;top:0px;right:140px;" onclick="javascript:reportReject();">
