...
<script type="text/javascript" src="<%=request.getContextPath()%>/examflow/djdexamflowin.js?randomId=<%=Math.random()%>"></script>
</head>
<body>
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
			...
			<dl>
			<dt>接收人员</dt>
			<dd><select class="easyui-combobox" id="toacc" name="toacc"
			...
			<dd>
				...
				<a href="javascript:flowcustadd();" class="easyui-linkbutton c6" style="width:100px;">导检单发送</a>
