...
<script type="text/javascript" src="<%=request.getContextPath()%>/examflow/djdexamflowtotalshowall.js?randomId=<%=Math.random()%>"></script>
</head>
<body>
...
<fieldset style="margin: 5px; padding-right: 0;">
	<legend>
		<strong>体检人员列表</strong>
			...
			<div id="selectexamflowsholist1"></div>
</fieldset>
</body>
</html>