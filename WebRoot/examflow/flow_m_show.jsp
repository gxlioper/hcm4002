...
<script type="text/javascript" src="<%=request.getContextPath()%>/examflow/flow_m_show.js?randomId=<%=Math.random()%>"></script>
...
$(function(){
	...
	//回车查询事件
	 ...
	 $('#screater').combobox({
			url : 'getflowUser.action?creater_state=m',
		...
		success:function(data){
			if(data==1){
				$("#dlg-beizhu").dialog({
					...
					width :800,
					height :500,
					href : 'remakPage.action?exam_num='+$('#exam_num_s').val()+"&process=7"
				});
...
<input type="hidden" id="report_print_type" value="<s:property value="model.report_print_type"/>">
	...
	<div title="解读室" style="padding:5px;" >
  <div id="main">
		<div id="left">	
		 ...
		 <div id="right">
    			...
    			<legend><strong>信息检索</strong></legend>
					<div class="user-query">
						<dl>
							...
							<dd><a href="javascript:chaxun();" class="easyui-linkbutton c6 l-btn l-btn-small"  style="width: 90px">查询</a></dd>
 			...
 			<fieldset style="margin:5px;padding-right:0; padding-top: 5px; padding-bottom: 20px; height: 520px; margin-right: 10px" >
    			<legend><strong>信息显示</strong></legend>							
					...
					<div title="解读内容" style="padding:5px;" >
					<dl>
					<dd><a href="javascript:flowmmessageupdate();" class="easyui-linkbutton"  style="width: 90px">保存</a></dd>
						</dl>
        				<dl><dd><textarea id="flowmmessage" cols="3" rows="3"  style="width: 900px; height: 361px;"></textarea></dd> 
                        </dl>
                     </div>   
...
<!-- 导检单分发 -->
	<div title="报告解读" style="padding:5px;">
	<fieldset style="margin:5px;padding-right:0; padding-top: 5px; padding-bottom: 20px; height: 110px; margin-right: 10px" >
    			<legend><strong>信息检索</strong></legend>
					...
					<dd><select class="easyui-combobox" id="exam_type" name="exam_type" data-options="height:26,width:140,panelHeight:'auto'">		    	       		
					 ...
					 <dt style="height:26px;width:80px;"><input id="ck_ptype" type="checkbox"/>状态</dt>
					<dd><select class="easyui-combobox" id="ptype" disabled="disabled" name="ptype" data-options="height:26,width:140,panelHeight:'auto'">		    	       		
		    	       		<option  value="2" selected="selected">已解读</option>
		    	       		<option  value="1" >未解读</option>
...
<div id="yq" class="fromDiv" style="padding-top: 100px;padding-left: 100px;z-index:-1;"></div>
