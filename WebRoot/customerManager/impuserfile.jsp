...
function closeWindowPal(){
	$('#dlg-show').dialog('close'); 
	$("#dlg-show-imp").dialog('close');
	try {
        if(typeof getimpcusGrid === "function") { //是函数    其中 FunName 为函数名称
			getimpcusGrid();  //存在此函数
        } 
    } catch(e) {}
}
...
<div id="search-buttons"  class="dialog-button-box">
	<div class="inner-button-box">
	    ...
	    <a href="javascript:closeWindowPal()" class="easyui-linkbutton" style="width:80px;">关闭</a>
	</div>
</div>
