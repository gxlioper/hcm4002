...
function IdCard(UUserCard,num){
	...
	function f_getDatadic() {
		...
		var degreeOfedu = '<s:property value="model.degreeOfedu"/>';
		$('#degreeOfedu').combobox({
			...
			onLoadSuccess : function(data) {
				for (var i = 0; i < data.length; i++) {
					if (data[i].id == degreeOfedu) {
						$('#degreeOfedu').combobox('setValue', data[i].id);
						break;
					} else {
		...
		var political_status = '<s:property value="model.political_status"/>';
		$('#ZZMM').combobox({
			...
			onLoadSuccess : function(data) {
				for (var i = 0; i < data.length; i++) {
					if (data[i].id == political_status) {
						$('#ZZMM').combobox('setValue', data[i].id);
						break;
					} else {
