...
<script type="text/javascript" src="<%=request.getContextPath()%>/customerManager/usergroupmanager.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>体检人员列表</strong></legend>
 ...
 <div id="dlg-printitem" class="easyui-dialog"  data-options="width: 700,height: 500,closed: true,cache: false,modal: true,top:50"></div>
  </body>