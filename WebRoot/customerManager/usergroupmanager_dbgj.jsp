...
<script type="text/javascript" src="<%=request.getContextPath()%>/customerManager/usergroupmanager_dbgj.js?randomId=<%=Math.random()%>"></script>
...
<legend><strong>信息检索</strong></legend>
			<div class="user-query">
			    ...
			    <dt style="height:26px;width:60px; margin-left: 19px;">状态</dt>	
				...
				<dt style="height:26px;width:60px;">选择单位</dt>					
					...
					<dt style="height:26px;width:60px;">开始日期</dt>
			        <dd><input class="easyui-datetimebox" type=text id="start_date" style="width:140px;height:26px;"></input>
			        <dt style="height:26px;width:60px;">结束日期</dt>
			        <dd><input class="easyui-datetimebox" type=text id="end_date" style="width:140px;height:26px;"></input>
				    ...
				    <dd><a href="javascript:getgroupuserGrid();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="width:50px;">查询</a>
				    <dd><a href="javascript:getocchangye();"  class="easyui-linkbutton c6 l-btn l-btn-small" style="width:80px;">设置行业</a></dd>
				    </dd>
				</dl>
			</div>
 </fieldset>
