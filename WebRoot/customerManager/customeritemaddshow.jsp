...
<script type="text/javascript" src="<%=request.getContextPath()%>/customerManager/customeritemaddshow.js?randomId=<%=Math.random()%>"></script>
...
<fieldset style="margin: 5px; padding-right: 0;">
	...
	<div class="user-query">
		...
		<dl>
			...
			<dd>
			    <label><input name="exam_indicator"  type="radio" checked value="T" />团体加项 </label> 
