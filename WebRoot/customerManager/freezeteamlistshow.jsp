...
<script type="text/javascript" src="<%=request.getContextPath()%>/customerManager/freezeteamlistshow.js?randomId=<%=Math.random()%>"></script>
	...
	<fieldset style="margin: 5px; padding-right: 0;">
		...
		<div class="user-query">
			<dl>
				...
				<dd>
					<input type="text" id="com_Name" value="" style="height:20px;width:160px;"/>
               ...
               <dl>
				   ...
				   <dd>
					   <input type="text" id="tjrw" value="" style="height:22px;width:160px;"/>
				...
				<dd>
				 ...
				 <dt style="height:26px;width:80px;"><input id="chkItem" name="chkItem" checked type="checkbox" value="update_date"/>冻结日期</dt>
			         <dd><input class="easyui-datebox" type=text id="time1" value="<s:property value="model.time1"/>" style="width:100px;height:26px;"></input>
                     <dt style="height:26px;width:20px;">至</dt>
			         <dd><input class="easyui-datebox" type=text id="time2" value="<s:property value="model.time2"/>" style="width:100px;height:26px;"></input>
