...
alter table exam_dep_result add dep_num varchar(20)  --科室编码
...
------------------------yangm 20190124---------------------------
--体检检查项目表
alter table examinfo_charging_item add charging_item_code varchar(50) 
--团体结算收费项目明细表，暂时无用
...
alter table exam_Critical_detail        add disease_num varchar(50)  