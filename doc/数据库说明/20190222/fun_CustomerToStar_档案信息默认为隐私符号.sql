GO
/****** Object:  UserDefinedFunction [dbo].[fun_CustomerToStar]    Script Date: 03/11/2019 08:59:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create function [dbo].[fun_CustomerToStar](
  /*************将明文字符转成加密符号**************/
  @customer_id  int,
...
begin
  ...
  --判断体检者是否需要加密的人员类型  
  if (exists (select c.id from customer_info  c where c.id=@customer_id))
    set @is_encrypt=1
  else
    set @is_encrypt=0
