	...
	BEGIN TRAN Tran_auto
	  begin try
		...
		***********************************************/
		...
		where c.id = w.summary_id and c.daily_status = 0 and c.cashier = @userid and c.center_num=@center_num group by w.charging_way   
		...
		where c.daily_status = 0 and c.cashier = @userid and c.center_num=@center_num and c.exam_id = e.id
